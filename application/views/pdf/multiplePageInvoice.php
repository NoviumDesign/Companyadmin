...
function template($content, $header, $footer) {
	...
	<dimensions:595 842; padding:35>
		' . $header . '
		<dimensions:525 507; margin-top:25; background-color:#123321>' . $content . '</>
		' . $footer . '
	</>
	';
}
...
$firstPage = '
' . $descriptions  . '
	<dimensions:525 451; background-color:#543345;>
	' . $itemsHeader . '
		<dimensions:525 190; margin-top:-13>
...
$secondPage = '
	...
	' . $itemsHeader . '
		<dimensions:525 190; margin-top:-13>
		' . implode('', array_slice($_items, 0, 26)) . '
		</>
	</>
';
...
$this->document[0] = template($firstPage, $header, $footer);
$this->document[1] = template($secondPage, $header, $footer);
